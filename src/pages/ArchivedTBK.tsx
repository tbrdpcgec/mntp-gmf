...
const COLUMN_ORDER: { key: string; label: string }[] = [
  ...
  { key: 'remark_sm1', label: 'Remark Sheetmetal' },
  { key: 'handle_by_sm1', label: 'Handle by Sheetmetal' },
  { key: 'date_closed_sm1', label: 'Date Closed Sheetmetal' },

  { key: 'status_cs1', label: 'Composite' },
  { key: 'remark_cs1', label: 'Remark Composite' },
  { key: 'handle_by_cs1', label: 'Handle by Composite' },
  { key: 'date_closed_cs1', label: 'Date Closed Composite' },
