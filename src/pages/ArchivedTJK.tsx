...
const COLUMN_ORDER: { key: string; label: string }[] = [
  ...
  { key: 'remark_sm4', label: 'Remark Sheetmetal' },
  { key: 'handle_by_sm4', label: 'Handle by Sheetmetal' },
  { key: 'date_closed_sm4', label: 'Date Closed Sheetmetal' },

  { key: 'status_cs4', label: 'Composite' },
  { key: 'remark_cs4', label: 'Remark Composite' },
  { key: 'handle_by_cs4', label: 'Handle by Composite' },
  { key: 'date_closed_cs4', label: 'Date Closed Composite' },

  { key: 'other', label: 'Mach/Weld' },
  { key: 'nd', label: 'NDT' },
  { key: 'tjo', label: 'PAINTING' },
