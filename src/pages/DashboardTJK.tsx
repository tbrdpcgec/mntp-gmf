...
import DashboardTJKshop from './DashboardTJKshop';
import DashboardTJKhangar from './DashboardTJKhangar';

export default function DashboardTJK() {
...
>
  HANGAR
      ...
      {/* CONTENT */}
      {activeDashboard === 'WORKSHOP' && <DashboardTJKshop />}
      {activeDashboard === 'HANGAR' && <DashboardTJKhangar />}
    </div>
  );
}
