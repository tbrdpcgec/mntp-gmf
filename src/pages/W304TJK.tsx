...
function DownloadPDFButton({ pdfData, shift, filterReportOnly }) {
  ...
  const handleConfirm = async () => {
    ...
    link.href = url;
    link.download = `E-HOB MANTAP SHEETMETAL TJK ${pdfData.date} ${shift}.pdf`;
...
const supervisorList = [
  ...
  '580485 / ALIF YOGA APRILYANSAH',
  '580503 / TEGAR GILANG PRATAMA',
  '580506 / FARIS WALIYULLOH',
  '581000 / FENDI HANANTO',
  '581837 / ADITYA EKA NUGRAHA',
  '581841 / AHMAD IQBAL',
  '582367 / FAYDLIR RAHMAN',
  '582369 / GILANG SULTON ASYARI',
  '583322 / DANDYNO DUARTE',
  '583328 / KHAIRUL HASBI PUTRA',
  '783644 / CANDRA PURNAMA',
  '783645 / MUHAMMAD GILANG ALGHIFARI',
];
...
const managerOptions = ['580125 / NASHRUL FALACH'];
...
export default function W301() {
  ...
  const [showArchivedSM4, setShowArchivedSM4] = useState(false);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // 🔴 archive_sm4 filter pakai toggle
      if (!showArchivedSM4) {
    ...
    fetchData();
  }, [filterReportOnly, showArchivedSM4]);
        ...
        <div className=" mb-2 flex flex-wrap gap-1 items-center">
          ...
          <div className="flex flex-wrap items-center gap-1 text-xs mt-1 mb-1">
            ...
            <div className="flex flex-wrap items-center gap-1 text-xs">
              ...
              <button
                onClick={() => setShowArchivedSM4((prev) => !prev)}
  ...
  `}
              >
                {showArchivedSM4 ? 'Hide Archived' : 'Show Archived'}
              </button>
