...
function DownloadPDFButton({ pdfData, shift, filterReportOnly }) {
  ...
  const handleConfirm = async () => {
    ...
    const doc = <W305PDF data={pdfData} />;
    ...
    link.href = url;
    link.download = `E-HOB MANTAP CABIN TCR ${pdfData.date} ${shift}.pdf`;
...
const supervisorList = [
  '580799 / HARRY HERSANTO',
  '581621 / REGGY GENIO DEVALDY CHANIAGO',
  '582400 / FIKRI HARY WIBOWO',
  '582460 / FEBRIAN SETYO NUGROHO',
  '582574 / SETYO HUTOMO',
  '582575 / NUGIE DWITYOPUTRO R',
  '783700 / GENTUR SETYO NUGROHO',
];
...
const managerOptions = ['532465 / NILA SAFIANA SARI'];
