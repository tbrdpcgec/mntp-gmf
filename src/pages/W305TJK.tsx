...
function DownloadPDFButton({ pdfData, shift, filterReportOnly }) {
  ...
  const handleConfirm = async () => {
    ...
    link.href = url;
    link.download = `E-HOB MANTAP COMPOSITE TJK ${pdfData.date} ${shift}.pdf`;
...
const supervisorList = [
  '532862 / EKO KURNIAJI PRAYITNO',
  '580120 / AGUNG JATI ASMARA',
  '580124 / ILYAS',
  '580631 / TAMRIN ANGGIAT TARULI NAPITUPULU',
  '580714 / IRFAN NUR ROCHMAN',
  '581011 / SOFYAN',
  '581233 / ABDUL KHOLIL',
  '581839 / AGUNG SAKTI PRASETYO',
  '581850 / HAMSYAH FERDINAND',
  '583318 / ILHAM SURYA PAMBUDI',
  '583319 / FARID MUTAQIN',
  '583331 / MUHAMMAD ALDI FERDIANSYAH',
  '583332 / MUHAMMAD BILAL ALIFFA',
  '584406 / CANDRA LESMANA',
];
...
export default function W301() {
  ...
  const [showArchivedCS4, setShowArchivedCS4] = useState(false);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // 🔴 archive_cs4 filter pakai toggle
      if (!showArchivedCS4) {
    ...
    fetchData();
  }, [filterReportOnly, showArchivedCS4]);
        ...
        <div className=" mb-2 flex flex-wrap gap-1 items-center">
          ...
          <div className="flex flex-wrap items-center gap-1 text-xs mt-1 mb-1">
            ...
            <div className="flex flex-wrap items-center gap-1 text-xs">
              ...
              <button
                onClick={() => setShowArchivedCS4((prev) => !prev)}
  ...
  `}
              >
                {showArchivedCS4 ? 'Hide Archived' : 'Show Archived'}
              </button>
